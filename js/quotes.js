const quotes = [
    ...
    { quote: "예수께서 대답하시되 이 사람이나 그 부모의 죄로 인한 것이 아니라 그에게서 하나님이 하시는 일을 나타내고자 하심이라", author: "요한복음 9:3" },
    { quote: "사람이 마음으로 자기 길을 계획할지라도 그 걸음을 인도하시는 분은 여호와이시니라.", author: "잠언 16:9" },
